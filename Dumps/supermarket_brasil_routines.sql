...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `ordersperstateview` AS select `supermarket_info`.`State` AS `State`,count(distinct `supermarket_info`.`Order_Id`) AS `NumberOfOrders` from `supermarket_info` group by `supermarket_info`.`State` order by `NumberOfOrders` desc */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50106 CREATE*/ /*!50117 DEFINER=`root`@`localhost`*/ /*!50106 EVENT `CreateSupermarket_infoEvent` ON SCHEDULE EVERY 1 MINUTE STARTS '2023-11-12 12:45:00' ENDS '2023-11-12 13:45:00' ON COMPLETION NOT PRESERVE ENABLE DO BEGIN
...
-- Dump completed on 2023-11-12 12:54:44
